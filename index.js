...
const client = new Client({
  phoneNumber: '38508844', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
  ...
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "42594277@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "42594277@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
